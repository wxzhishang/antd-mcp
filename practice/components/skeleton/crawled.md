...
1. **骨架屏 Skeleton - Ant Design - 段落 5** (相关性: 35%)
   - 链接: https://ant.design/components/skeleton-cn
   - 摘要: We supply a series of design principles, practical patterns and high quality design resources (Sketch and Axure), to help people create their product prototypes beautifully and efficiently.
...
基于收集到的信息，建议在使用 Skeleton 组件时注意以下几点：
