...
4. **字节跳动旗下 ArcoDesign 开源啦** (相关性: 30%)
...
15. ** 项目升级nextjs15, antd5和node20 踩坑记录** (相关性: 30%)
   - 链接: https://juejin.cn/post/7441094982978207784
   - 摘要: 因为项目目前统一用的node 16.15.0 已经逐渐废弃所以需要升级系统依赖nextjs 12.3.4 →  15.0.3, antd v4.23.5 → v5.22.1 node 16.15.0
...
18. **按需加载更优雅的解决方案——vite-plugin-components** (相关性: 30%)
   - 链接: https://juejin.cn/post/6976558626425028645
   - 摘要: 自动按需加载实践，无需手动注册，使用vite-plugin-components,解决antd自动按需加载的问题
...
基于收集到的信息，建议在使用 Mentions 组件时注意以下几点：
